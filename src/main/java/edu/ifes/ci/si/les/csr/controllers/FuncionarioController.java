...
import edu.ifes.ci.si.les.csr.services.FuncionarioService;
...
public class FuncionarioController {
    ...
    public ResponseEntity<List<Funcionario>> findAll() {
        List<Funcionario> collection = service.findAll();
    ...
    public ResponseEntity<Funcionario> findVerificarLogin(@PathVariable String login, @PathVariable String senha) {
        Funcionario obj = service.findVerificarLogin(login, senha);
        return ResponseEntity.ok().body(obj);
    }
